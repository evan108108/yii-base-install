<?php 
  $this->breadcrumbs = array(
	...
	(Rights::getAuthItemTypeNamePlural($model->type) == 'Tasks')?'Businesses':	Rights::getAuthItemTypeNamePlural($model->type)=>Rights::getAuthItemRoute($model->type),
	$model->name,
); ?>
...
<div id="updatedAuthItem" >
	...
	<?php $this->renderPartial('_form', array('model'=>$formModel, 'modelType'=>$model->type)); ?>

	<div class="relations span-11 last" style="padding-left:50px;">
